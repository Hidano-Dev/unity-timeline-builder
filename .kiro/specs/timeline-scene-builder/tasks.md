...
- [ ] 1.1 (P) Scene 構築情報の型付き不変モデルを定義する
...
- [ ] 7. (P) CSV テンプレートと列定義ドキュメントを Scene 行仕様に同期する
