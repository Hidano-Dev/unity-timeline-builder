...
- [x] 1. Foundation: embedded package の骨組みを作成する
...
- [x] 1.2 Editor 専用アセンブリ定義とテスト用アセンブリ定義を作成する
...
- [x] 3. Parsing: 構築情報の読み取りと検証を実装する
- [x] 3.1 (P) CSV/TSV リーダーを実装する
...
- [x] 3.2 構築情報パーサー(ヘッダー認識・列マッピング・行検証)を実装する
...
- [x] 4. Resources: リソース解決とインポートを実装する
- [x] 4.1 (P) 外部ファイルのコピー・同期インポート処理を実装する
...
- [x] 4.2 (P) リソースリゾルバの契約とレジストリを実装する
...
- [x] 4.4 (P) AnimationClip リゾルバを実装する
...
- [x] 5. Building: Timeline と Prefab の生成を実装する
- [x] 5.1 (P) トラックビルダーの契約とレジストリを実装する
...
- [x] 5.4 TimelineAsset ファクトリ(グルーピング・保存・上書き)を実装する
...
- [x] 8. (P) CSV テンプレートと列定義ドキュメントを同梱する
...
- [x] 9. Validation: 統合テストと E2E で全体を検証する
- [x] 9.1 Timeline 構築の統合テストを作成する
...
- [x] 9.2 (P) 外部リソースインポートの統合テストを作成する
...
- [x] 9.3 (P) Prefab 生成と上書き冪等性の統合テストを作成する
...
- [x] 9.4 (P) 同梱テンプレートを入力とする E2E テストを作成する
